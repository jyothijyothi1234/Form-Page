...
>
          ...
          >
            <LinkedInIcon sx={{ pr: {xs:1,md:2},height:"50px",width:"50px" }} />
            <GitHubIcon sx={{ pr: {xs:1,md:2},height:"50px",width:"50px"  }} />
            <TwitterIcon sx={{ pr: {xs:1,md:2},height:"50px",width:"50px"  }} />
            <YouTubeIcon sx={{ pr: {xs:1,md:2},height:"50px",width:"50px"  }} />
          </Grid>
        </Grid>
      </Grid>
    </Grid>
